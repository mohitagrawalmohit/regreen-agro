    ...
    <main className="min-h-screen bg-gray-50 text-gray-800 px-6 md:px-20 py-10">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="prose prose-gray max-w-none text-justify">
          <p>
            This Privacy Policy (“Policy”) explains how <strong>Regreen Agro</strong> (“Company”,
            “we”, “our”, or “us”) collects, uses, discloses, and safeguards your information when
            you use our website <a href="https://www.regreenagro.in" className="text-green-600 underline">https://www.regreenagro.in</a> 
          ...
          <ul>
            <li>Personal details such as name, email address, phone number, billing and shipping addresses.</li>
            <li>Payment details when purchasing products through our Platform.</li>
            <li>Technical information such as IP address, browser type, device type, operating system, and access logs.</li>
          ...
          <ul>
            ...
            <li>Sending you updates, promotional offers, and marketing communications (only if you opt-in).</li>
          ...
          <ul>
            <li>Trusted service providers and logistics partners who help us deliver products or provide services.</li>
          ...
          <p>
            We use appropriate technical and organizational measures to protect your information from
            unauthorized access, alteration, disclosure, or destruction. However, please understand
          ...
          <p>
            Our Platform may use cookies and similar technologies to enhance your browsing experience,
            analyze trends, and gather demographic information. You can disable cookies via your browser
            settings, but this may limit certain functionalities of the Platform.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">6. Your Rights</h2>
          <p>
            Depending on your jurisdiction, you may have the right to access, correct, or delete your
            personal data. You may also opt out of receiving promotional communications by contacting us.
          </p>
          ...
          <p>
            We reserve the right to update this Privacy Policy from time to time. Any changes will be
            posted on this page with the updated effective date. Continued use of the Platform after
          ...
          <p>Email: <a href="mailto:support@regreenagro.in" className="text-green-600 underline">support@regreenagro.in</a></p>
        </div>
      </div>
    </main>
  );
