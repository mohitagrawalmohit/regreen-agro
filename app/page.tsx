...
export default function HomePage() {
  ...
  {!showVideo ? (
    <div className="h-full w-full bg-cover bg-center bg-no-repeat bg-[url('/hero-bg-mobile-min.png')] md:bg-[url('https://regreenagro.s3.ap-southeast-2.amazonaws.com/hero-video.webm')]" />
  ) : (
