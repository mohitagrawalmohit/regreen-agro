...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { href: '/category/Power%20Weeder%20&%20Tiller', label: 'Categories', dash: '0 12.6 9.5 49.3 9.5 31.6' },
  ...
  // Close menus on category product page
  useEffect(() => {
    ...
    <header className="bg-white text-black shadow-md sticky top-0 z-50">
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-50 flex">
          ...
          {/* Right 50% drawer */}
          <div className="w-1/2 bg-white shadow-md p-4 flex flex-col">
